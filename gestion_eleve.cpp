...
void gestion_eleve::on_pb_ajouter_2_clicked()
{


    QString NUMINSC=ui->le_id_2->text();
    QString NOM=ui->le_nom_2->text();
    QString PRENOM=ui->le_prenom_2->text();
    QString DATEN = ui->le_date_2->text();
    QString SEXE=ui->comboBox_sexe_2->currentText();
    QString AGE=ui->le_age_2->text();
...
void gestion_eleve::on_pushButton_modifier_2_clicked()
{
    ...
    QString DATEN = ui->le_date_2->text();
    QString SEXE=ui->comboBox_sexe_2->currentText();
    QString CLASSE=ui->le_age_2->text();


    Eleve E(NUMINSC,NOM, PRENOM, DATEN, SEXE, CLASSE);
...
void gestion_eleve::on_PDF_clicked()
{
                            ...
                            QPdfWriter pdf("C:/Users/Ramzi/Desktop/session_septembre/img/listdeseleves.pdf");
                                ...
                                QPainter painter(&pdf);
                                       ...
                                       QImage image1("C:/Users/Ramzi/Desktop/session_septembre/img/photo4.jpg");
